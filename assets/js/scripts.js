...
var buttonTemplate = Handlebars.compile($('#product-pairing-button-template').html());
...
var ProductPairingButtonView = function () {
  ...
  return ProductPairingButtonView;
}();
...
var _ProductPairingButtonView = require('./ProductPairingButtonView');

var _ProductPairingButtonView2 = _interopRequireDefault(_ProductPairingButtonView);
...
var RecipesView = function () {
  ...
  _createClass(RecipesView, [{
    ...
    value: function renderRecipes(props) {
      ...
      var $recipes = $('<div class="recipe-group"></div>');
      var $rows = [];
      ...
      var planTypeDisplayNames = {
        two_person: 'Two Person Plan',
        family: 'Family Plan'
      };

      var displayWeek = (0, _moment2.default)(props.weekSelected).format('MMMM Do');
      var displayPlanType = planTypeDisplayNames[props.planTypeSelected];
...
var _WeekSelectorView2 = _interopRequireDefault(_WeekSelectorView);

var _RecipesView = require('./RecipesView');
